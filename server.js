...
const APP_ID = "cf22b9c1495d4cc89b36a9a81f9cfa16";
const APP_CERTIFICATE = "isi-certificate-asli-kamu-disini";

app.get('/', (req,res)=> res.send('Masguntoro Token Server Jalan'));

app.get('/token', (req, res) => {
  const channel = req.query.channel;
  if (!channel) return res.status(400).json({error: "channel?"});
